...
//  TriviaPotter
//
//  Created by Daniel Cazorro Frías on 8/1/25.
//
        ...
        GeometryReader { geo in
            ZStack {
                ...
                VStack {
                    ...
                    VStack {
                        if animateViewsIn {
                            Text("Who is the Hogwarts Headmaster?")
                        ...
                        VStack {
                            if animateViewsIn {
                                Image(systemName: "questionmark.app.fill")
                                    ...
                                    .overlay(
                                        Text("The boy is lost in the woods")
                                            .padding(.leading, 33)
                ...
                VStack {
                    ...
                    .animation(.easeInOut(duration: tappedCorrectAnswer ? 1 :0).delay(1), value: tappedCorrectAnswer)
